...
struct FeatureFlags {
    ...
    /// Default is false (UserDefaults.bool returns false for unset keys).
    /// Togglable at runtime via the menu in HomeView.
    static var v2EnhancedExtraction: Bool {
        UserDefaults.standard.bool(forKey: "v2EnhancedExtraction")
    }
}
